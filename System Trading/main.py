...
from PyQt5.QtCore import QTime, QTimer, Qt, QDateTime, QDate, QThread, QEventLoop
...
class MyWindow(QMainWindow, form_class):
    ...
    def login(self):
        ...
        self.daishin = Daishin(msg_on=True)
    ...
    def send_order(self):
        ...
        if (current_time >= QTime(9, 0, 0)) and (current_time <= QTime(15, 30, 0)):
            ...
            self.daishin.send_order(f"{order_type_lookup[order_type]}", str(code), int(volume))
